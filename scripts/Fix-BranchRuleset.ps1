...
param(
    [Parameter()]
    [string]$Repository = "Chris-Wolfgang/String-Extensions",
...
if ($Repository -eq "Chris-Wolfgang/String-Extensions" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "Chris-Wolfgang/String-Extensions") {
